(function (window, angular) {
    ...
    angular.module('public', ['ngCookies'])
        .service('API', ['$http', '$rootScope', '$cookies', '$cookieStore', 'getSign', 'browser','getParamsCode', function ($http, $rootScope, $cookies, $cookieStore, getSign, browser,getParamsCode) {
            ...
            var httpInt = function (intObj, ajaxUrl) {
                ...
                if (browser.isApp) {
                    ...
                    var publicParams = {
                        ...
                        usertype: 1,
                        cmdName: $cookies.get('from') || getParamsCode('frm') || 'h5_zz',
